...
<div class="d-flex justify-content-center aligns-items-center border-primary" style="background-color:#42424d">
    <img src="{{asset('/images/img1 (2).JPG')}}" alt="img" style="margin-right:20px; height:550px; margin-top:30px" >
...
<div class="form-group">
    <label for="dateofbith" class="form-label text-white fs-5">Date de naissance</label>
    <input type="date" name="dateofbirth" class="form-control form-control-sm" id="dateofbirth">
</div>

<div class="form-group">
    <label for="hobbies" class="form-label text-white fs-5">Hobbies</label>
    <input type="text" name="hobbies" class="form-control form-control-sm" id="hobbies">
</div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control form-control-sm" name="bio" id="bio">
</div>

<div class="form-group">
    <label for="picture" class="form-label text-white fs-5">Ajouter une photo</label>
    <input type="file" name="picture" class="form-control form-control-sm" id="picture">
</div>
<br>
<button type="submit" class="btn btn-primary text-black mb-3 text-white fs-5">Ajouter</button>
</form>
</div>
@endsection